...
using MarioTravel.Admin.Data;
using MarioTravel.Admin.Infrastructure;
using MarioTravel.Admin.Infrastructure.ApplicationUserClaims;
using MarioTravel.Admin.Infrastructure.AppSettingsModels;
...
using MarioTravel.Admin.Infrastructure.Startup;

namespace MarioTravel.Admin
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Cookie.Name = "MarioTravel.Admin.DotNetCore.AppCookie";
            ...
            services.AddSession(options =>
            {
                ...
                options.Cookie.Name = "MarioTravel.Admin.DotNetCore.SessionCookie";
                // You might want to only set the application cookies over a secure connection:
                // options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
                options.Cookie.SameSite = SameSiteMode.Strict;
                options.Cookie.HttpOnly = true;
